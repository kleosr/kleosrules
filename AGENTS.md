...
| Need | Path | Notes |
|------|------|-------|
| Paste User Rules | `user-rules/USER-RULES.paste.txt` | V16.0.22 Option C (pack_native React; Rust-only; Python bypass deny) |
...
| Pack version | `package.json` | `16.0.22` (kleosr) |
