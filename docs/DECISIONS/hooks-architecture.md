...
**2026-08-12 — law coherence.** alwaysApply `.mdc` install user-only (`GLOBAL`). Project layer was `types` until 2026-09-04. Cloud `project-hooks` copies GLOBAL+SHARED. Steel hooks are stateless (secrets + shell). Paste/skills describe those four events.
