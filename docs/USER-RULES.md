# USER RULES — how to load Master Mind V15.6
...
2. Clear or replace any stale Settings User Rules box (avoid V11 + V15.6 double load)
3. New agent chat
...
(never waive M); breakthrough self-hunt uses Self-target pause. See
...
Then: `FORCE_SKILLS=1 hooks/bin/kleos-gate install`
