...
| 15 | https://x.com/AtMemX/status/2093597279819038795 | AtMemX (operator-supplied) | 2026-08-29 | “Instructions are probabilistic. Hooks are deterministic.” | opinion | medium | Maps to law (.mdc/skills) vs steel (four hooks) split in `docs/ARCHITECTURE.md` | Hypothesis support only |
