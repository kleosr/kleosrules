...
Source of synced always-on / requestable `.mdc` companions. Edit here; re-sync — do not hand-edit downstream copies.

## Where to look

| File | Role |
|------|------|
| `native-lean-autoload.mdc` | Always-on auto gates companion |
...
- Removing an always-on companion from the sync set
