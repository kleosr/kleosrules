...
[[ -z "$DUTY" ]] && DUTY="INTENT job card: OBJECTIVE=postcondition on named units; CONSTRAINTS=≤2 invariants/non-goals; Done-when=≤5 decidable predicates. User prompt immutable."
