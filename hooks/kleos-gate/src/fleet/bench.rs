...
pub fn run(hooks: &Path) -> ! {
    ...
    let cases_owned: Vec<(String, String, String, String)> = vec![
        ("shell".into(), "{\"command\":\"git push origin main --force\"}".into(), "deny".into(), "shell_force_push".into()),
        ...
        ("write".into(), "{\"tool_name\":\"Write\",\"tool_input\":{\"path\":\"src/a.ts\",\"contents\":\"export const n=1;\\n\"}}".into(), "deny".into(), "write_recall_gate".into()),
