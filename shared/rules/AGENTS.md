...
- User `~/.cursor/rules` (GLOBAL, once): agent.mdc, ponytail.mdc, pnpm.mdc (alwaysApply); testing.mdc, vibe.mdc, postgres.mdc, next.mdc, vite.mdc, astro.mdc, complexity.mdc (globs).
